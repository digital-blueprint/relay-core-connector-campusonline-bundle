...
use Dbp\Relay\CoreConnectorCampusonlineBundle\DbpRelayCoreConnectorCampusonlineBundle;
...
class Kernel extends BaseKernel
{
    ...
    public function registerBundles(): iterable
    {
        ...
        yield new DbpRelayCoreConnectorCampusonlineBundle();
    ...
    protected function configureContainer(ContainerConfigurator $container, LoaderInterface $loader)
    {
        ...
        $container->extension('dbp_relay_core_connector_campusonline', []);
    }
}
